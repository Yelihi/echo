...
export function PartnerCard({ role, children }: PartnerCardProps) {
  return (
    <div className="flex w-full flex-col items-center gap-3 rounded-lg border border-session-glass-line bg-session-glass px-5 py-6 text-center backdrop-blur-xl sm:px-8">
