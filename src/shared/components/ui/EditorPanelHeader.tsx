...
export const editorPanelHeaderVariants = cva(
  "group/editor-panel-header flex w-full items-center gap-2 border-b border-card-line bg-card-surface px-5 py-4",
);
...
export const EditorPanelHeader = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="flex size-6 shrink-0 items-center justify-center rounded-full bg-gray-background text-black-secondary [&_svg]:size-3.5">
        {icon}
      </span>
      <span className="min-w-0 flex-1 text-body-3 font-bold text-black-primary">{title}</span>
