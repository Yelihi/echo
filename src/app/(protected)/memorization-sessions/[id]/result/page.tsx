import { getMemorizationResultPageViewModel } from "@/views/analysis-result/server";
import { notFound } from "next/navigation";

import { AnalysisResultView, retryMemorizationAnalysis } from "@/views/analysis-result";
